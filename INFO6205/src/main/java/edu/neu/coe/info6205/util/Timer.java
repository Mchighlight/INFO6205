...
//    public <T, T> double repeat(int n, Supplier<T> supplier, Function<T, T> function,  UnaryOperator<T> preFunction, Consumer<T> postFunction) {
//        logger.trace("repeat: with " + n + " runs");
//        // FIXME: note that the timer is running when this method is called and should still be running when it returns. by replacing the following code
//        for (int i = 0; i < n; i++) {
//        	
...
//        		function.apply(supplier.get());
//        	}
//        	//postFunction.accept(supplier.get());
//        	
//        	if(preFunction !=null) {
//        		//preFunction.compose(postFunction).apply(supplier.get());
//        		preFunction.andThen(function).apply(supplier.get());
//        		//postFunction.accept(function);
//        		postFunction.accept(supplier.get());
// 
//
//        		//function.andThen(postFunction).apply(supplier.get());
//        	}
//      
//        	
//        	
...
//    }
    ...
    private static long getClock() {
    	...
    	//System.out.print("Nanotime: " + String.valueOf(timeInNanoSeconds));
